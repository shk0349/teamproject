...
public class LoginDTO {
	...
	String id,nickname,pw,name,gender,birth,phone,phone1,phone2,address,email,fdomain,bdomain,fgrade;
	...
	public LoginDTO(String id, String nickname, String pw, String name, String gender, String birth, String phone,
			String phone1, String phone2, String address, String email, String fdomain, String bdomain, String fgrade) {
		super();
		this.id = id;
