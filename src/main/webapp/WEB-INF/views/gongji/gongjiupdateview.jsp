...
<caption><h3>공지사항</h3></caption>
	<tr>
		...
		<td style="text-align: left;">
			<input type="text" name="gtitle" style="width:1250px" value="${list.gtitle}" required="required">
	...
	<tr>
		<th>내용</th>
		<td style="text-align: left;">
			<textarea rows="20" cols="175px" name="gcontents" required="required">${list.gcontents}</textarea>
		</td>
	</tr>
	<tr>
		<th>파일첨부</th>
