...
<table align="center" width="900px" border="1">
<caption><br><h2> ↳ Q&A : 답변 드립니다.</h2></caption>
<c:forEach items="${replylist}" var="replylist">
	<tr>
		<th>문의 종류</th><td>${replylist.tab}</td>
	</tr>
	<tr>
		<th>답변 제목</th><td>${replylist.title}</td>
		<th>문의 일자</th><td>${replylist.fdate}</td>
	</tr>
	<tr>
		<td colspan="4">
			${replylist.nickname}님, 안녕하세요.<br>
			${replylist.fcontents}<br>
			이라는 문의 내용을 확인했습니다.
			<br>
			이에 아래와 같이 답변 드리겠습니다.<br>
			답변 내용 : ${replylist.fcontents}
		</td>
	</tr>
</c:forEach>
</table>
